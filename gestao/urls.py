...
urlpatterns = [
    ...
    path('dispositivi/nuovo/', views.crea_dispositivo_singolo, name='crea_dispositivo_singolo'),
    path('dispositivi/lotto/', views.crea_lotto_dispositivi, name='crea_lotto_dispositivi'),
